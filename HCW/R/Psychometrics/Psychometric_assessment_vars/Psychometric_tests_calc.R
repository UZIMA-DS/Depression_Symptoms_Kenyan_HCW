...
baseline_psychometric_scores_data <- process_scores(baseline_data_1, baseline_vars_list)%>% filter(!is.na(phq_score))
quarter1_psychometric_scores_data <- process_scores(quarter1_data_1, quarter1_psychometric_vars_list)%>% filter(!is.na(phq_score))
quarter2_psychometric_scores_data <- process_scores(quarter2_data_1, quarter2_psychometric_vars_list)%>% filter(!is.na(phq_score))
quarter3_psychometric_scores_data <- process_scores(quarter3_data_1, quarter3_psychometric_vars_list)%>% filter(!is.na(phq_score))
quarter4_psychometric_scores_data <- process_scores(quarter4_data_1, quarter4_psychometric_vars_list)%>% filter(!is.na(phq_score))
